...
ITEMS = {};
LOADED_date_range = {}; // start and end date range of entries loaded in ITEMS
...
// JS generating HTML using data
	function _draw_entries(){
		...
		if(VIEW == 'month_view'){
			...
			// day names
			tempDATA['day_names'] = DD.day_names;
